...
const uiText = {
    'zh-Hant': { 
        ...
        "kwGreeting": ["hi", "hello", "你好"],
        "kwThanks": ["唔該", "多謝", "謝謝", "thanks"],
        "kwBye": ["拜拜", "bye", "再見"],
        "kwPraise": ["好醒", "厲害", "勁", "正"],
        "kwJoke": ["笑話", "gag", "講嘢"],
        "kwSmallTalkExtra": ["天氣", "傾偈", "聊天"],
        "kwOmg": ["omg", "天啊", "我的天"],
        "kwAgreement": ["係呀", "是啊", "冇錯"],
        "kwHelp": ["幫手", "help", "救命", "點用"],
        "kwWho": ["你係邊個", "你是誰", "你叫咩名"],
        "kwNoProduct": ["搵唔到", "找不到", "冷門"],
        "kwPrivacy": ["個資", "隱私", "私隱", "安全"],
        "kwAlert": ["提示", "鐘仔", "alert", "追蹤"],
        "kwGap": ["差價", "激抵"],
        "kwHome": ["畫面", "主螢幕", "安裝"],
...
本程式以「現況」形式提供，用戶須自行承擔風險。對於任何因使用、依賴本程式資訊，或因數據延遲、價格差異而引致之任何損失或損害，本應用程式及開發者概不承擔任何法律責任。`,
    ...
    'zh-Hans': { 
        ...
        "kwGreeting": ["hi", "hello", "你好"],
        "kwThanks": ["唔该", "多谢", "谢谢", "thanks"],
        "kwBye": ["拜拜", "bye", "再见"],
        "kwPraise": ["好醒", "厉害", "劲", "正"],
        "kwJoke": ["笑话", "gag", "讲嘢"],
        "kwSmallTalkExtra": ["天气", "倾偈", "聊天"],
        "kwOmg": ["omg", "天啊", "我的天"],
        "kwAgreement": ["系呀", "是啊", "没错"],
        "kwHelp": ["帮手", "help", "救命", "点用"],
        "kwWho": ["你是边个", "你是谁", "你叫咩名"],
        "kwNoProduct": ["揾唔到", "找不到", "冷门"],
        "kwPrivacy": ["个资", "隐私", "私隐", "安全"],
        "kwAlert": ["提示", "钟仔", "alert", "追踪"],
        "kwGap": ["差价", "激抵"],
        "kwHome": ["画面", "主屏幕", "安装"],
        
        "replyGreeting": "你好呀！我是您的专属格价助手 🤖，今日想买点什么？", 
        "replyThanks": "不用客气！帮您省到钱我也非常开心！🛒✨",
        "replyBye": "拜拜！有买贵没买错，下次去超市扫货前记得再找我格价呀！👋",
        "replyPraise": "多谢赞赏！😎 我会继续努力盯紧各大超市的最新靓价！",
        "replyJoke": "为什么去超市买东西要带计算器？...因为要算着点神仙（仙=cents）！😆 好啦，烂Gag讲完，有想找什么？",
        "replySmallTalkExtra": "我是专注帮大家省钱的格价助手！🛒 虽然我不太懂看天气或者聊天，但我找特价货绝对是一流的！",
        "replyOmg": "OMG！😱 是不是看到超抵特价吓到呀？还是买太多拿不走？🛒💨",
        "replyAgreement": "是啊！我这个助手是不是很聪明呢？😎",
        "replyHelp": "不用惊！只要输入货品名，我就会帮您格价！或者点击『查看全部』看下有什么笋货？🛒",
        "replyWho": "我是专为您而设的格价助手！目的只有一个：帮您省钱，省到尽！💰",
        "r_no_product": "“悭真D”主要监察约 3,000 款民生必需品。极冷门或单一超市独家发售的货品未必涵盖，建议用简单的关键字搜索！",
        "r_privacy": "即系统 100% 纯前端离线运作，免登录、免注册，绝不收集或储存您的电话、Email 或任何隐私资料！",
        "r_alert": "在产品卡片点击一下【橙色钟仔 🔔】，输入心水价即可追踪。每日开 App 系统会自动对奖，到价时顶部红点会闪烁提示！",
        "r_gap": "点击底部的【🔥 超大差价】快捷键，系统会瞬间帮您筛选出商户之间价格相差超过 10% 的暴利或极具性价比货品！",
        "r_home": "iOS 用户请用 Safari 开启并点击“分享 ➔ 添加到主屏幕”；Android 用户请用 Chrome 点击“⋮ ➔ 添加到主屏幕”。",
