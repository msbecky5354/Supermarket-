...
function checkSmallTalk(q, exactOnly = false) {
   ...
   // 10. 身份查問 (已優化字根，移除多餘標點符號，涵蓋最地道口語)
{ words: ['你是誰', '你係邊個', 'who are you', 'who r u', '咩名', '乜名', '叫咩名', '乜水', '咩水', '邊位', '機器人', 'robot', '人工智能', 'ai', '你係咩', '咩機', '咩黎', '咩嚟', '咩來', 'bot'], reply: uiText[currentLang].replyWho },
